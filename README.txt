...
If you want to tinker around with the source code, please download or install Luckode from either the releases page or from itch.io, where Luckode is primarily hosted.

Luckode is compatible with all versions of Windows from Windows 2000, and partially compatible with Windows NT 4.0.
